function modalcartFunc(categorymodal, idmodal){
    ...
    <div class="product_modal_container_in">
                    ...
                    <div class="color_modal_in_area">Цвет: <div class="color_sec_in_modal" style="background-color: ${novmodalcard.color};"></div><span>Лаванадла</span></div>
                    <div class="height_modal_in_area">Высота:
                    ${novmodalcard.height}</div>
                    ...
                    <div class="name_price_container_modal_in">
                        <h2>${novmodalcard.name}</h2>
                        <span class="numbers">
                        ${novmodalcard.price}
                        </span>
                    </div>
